...
import { Newspaper, Zap, Flame, ArrowLeft, History, Heart, Share2, Search } from "lucide-react"
                ...
                <DialogContent className="sm:max-w-[700px] p-0 overflow-hidden border-0 rounded-[40px] shadow-2xl bg-card">
                    {selectedLog && (
                        <div className="flex flex-col h-full">
                            <DialogHeader className="p-10 bg-emerald-500/5 border-b border-border/50 text-left">
                                <Badge className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 text-[10px] font-black uppercase px-3 py-1 mb-4 h-auto w-fit">
                                ...
                                <DialogDescription className="flex items-center gap-4 text-sm font-bold text-muted-foreground uppercase tracking-widest">
                                    <span className="flex items-center gap-2"><History className="h-4 w-4" /> {selectedLog.time}</span>
                                    <span>Authored by @{selectedLog.author}</span>
                                </DialogDescription>
                            </DialogHeader>
                            <div className="p-10 space-y-8">
                                <div className="space-y-6">
                                    <div className="p-6 rounded-[32px] bg-emerald-500/5 border border-emerald-500/10">
                                        <h4 className="text-[10px] font-black uppercase tracking-widest text-emerald-500 mb-2">Executive Summary</h4>
                                        <p className="text-base font-bold text-foreground leading-relaxed italic">
                                            "{selectedLog.preview}"
                                        </p>
                                    </div>
                                    <div className="space-y-4">
                                        <h4 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Detailed Deep Dive</h4>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    >
                                        {selectedLog.liked ? "Liked Log" : "Like Log"}
                                    </Button>
                                    <Button
                                        variant="outline"
                                        className="flex-1 h-14 rounded-2xl border-2 font-black uppercase tracking-tight"
                                        onClick={() => {
                                            toast.success("Link Copied", { description: "Technical insight ready to share." })
                                        }}
                                    >
                                        Share Log
                                    </Button>
