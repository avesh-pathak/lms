        ...
        <div className="min-h-screen bg-background text-foreground selection:bg-primary/20">
            ...
            <nav className="fixed top-0 w-full z-50 border-b bg-background/80 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-bold uppercase tracking-widest text-[#64748b] dark:text-white">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden min-h-[600px]">
                ...
                <div className="max-w-7xl mx-auto px-6 text-center space-y-8">
                    ...
                    >
                        <Badge variant="outline" className="py-2 px-6 rounded-full border-[#FB923C]/20 bg-[#FB923C]/5 text-[#FB923C] font-black uppercase tracking-[0.2em] text-sm">
                            Babua LMS
                        </Badge>
                    </motion.div>
                    <motion.h1
                        ...
                        viewport={{ once: true }}
                        variants={fadeIn}
                        className="text-4xl md:text-6xl lg:text-8xl font-black tracking-tighter leading-[0.85] max-w-5xl mx-auto uppercase"
                    >
                        REAL ENGINEERING <br />
                    ...
                    >
                        <Link href="/dashboard">
                            <Button size="lg" className="h-16 px-12 rounded-2xl bg-[#FB923C] hover:bg-[#FB923C]/90 text-white font-black uppercase tracking-tight shadow-2xl shadow-[#FB923C]/20 text-lg group border-none">
                                Start Building <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                            </Button>
                        </Link>
                        <Link href="/dashboard/hackathons">
                            <Button size="lg" variant="outline" className="h-16 px-12 rounded-2xl border-2 font-black uppercase tracking-tight text-lg group">
                                <Trophy className="mr-2 h-5 w-5 text-[#FB923C]" aria-hidden="true" />
                                Join Hackathons
                            </Button>
                        </Link>
                        <a href="#paths">
            ...
            <section id="paths" className="py-24 bg-background overflow-hidden">
                <motion.div
                    initial="initial"
                    whileInView="animate"
                ...
                >
                    <motion.div variants={fadeIn} className="flex flex-col items-center text-center space-y-4 mb-20">
                    ...
                    >
                        {/* DSA Path */}
                        <motion.div variants={fadeIn} className="group p-8 rounded-[40px] border bg-card hover:border-[#FB923C] transition-all hover:-translate-y-2 relative overflow-hidden hover:shadow-xl">
                            <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 group-hover:opacity-20 transition-all">
                                <Code2 className="h-20 w-20 text-[#FB923C]" aria-hidden="true" />
                            </div>
                            <div className="space-y-6 relative">
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black uppercase tracking-tight">Babua LMS</h3>
                        ...
                        <motion.div variants={fadeIn} className="group p-8 rounded-[40px] border bg-card hover:border-[#FB923C] transition-all hover:-translate-y-2 relative overflow-hidden hover:shadow-xl">
                            <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 group-hover:opacity-20 transition-all">
                                <Layers className="h-20 w-20 text-[#FB923C]" aria-hidden="true" />
                            </div>
                            <div className="space-y-6 relative">
                                <div className="space-y-2">
                        ...
                        <motion.div variants={fadeIn} className="group p-8 rounded-[40px] border bg-card hover:border-[#FB923C] transition-all hover:-translate-y-2 relative overflow-hidden hover:shadow-xl">
                            <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 group-hover:opacity-20 transition-all">
                                <PencilRuler className="h-20 w-20 text-[#FB923C]" aria-hidden="true" />
                            </div>
                            <div className="space-y-6 relative">
                                <div className="space-y-2">
                        ...
                        <motion.div variants={fadeIn} className="group p-8 rounded-[40px] border-2 border-dashed border-[#FB923C]/30 bg-[#FB923C]/5 hover:border-[#FB923C] transition-all hover:-translate-y-2 relative overflow-hidden shadow-sm">
                            <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 transition-transform">
                                <Sparkles className="h-20 w-20 text-[#FB923C]" aria-hidden="true" />
                            </div>
                            <div className="space-y-6 relative">
                                <div className="space-y-2">
            ...
            <section className="py-24 border-y bg-muted/30 relative overflow-hidden">
                ...
                >
                    {/* Unified Hub Card */}
                    <motion.div variants={fadeIn} className="group p-10 rounded-[40px] border bg-card hover:border-[#FB923C]/50 transition-all hover:-translate-y-2 relative overflow-hidden shadow-sm">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:scale-110 transition-transform">
                            <Zap className="h-24 w-24 text-[#FB923C]" aria-hidden="true" />
                        </div>
                    ...
                    {/* Pattern First Card */}
                    <motion.div variants={fadeIn} className="group p-10 rounded-[40px] border bg-card hover:border-emerald-500/50 transition-all hover:-translate-y-2 relative overflow-hidden shadow-sm">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:scale-110 transition-transform">
                            <Layers className="h-24 w-24 text-emerald-500" aria-hidden="true" />
                        </div>
                        <div className="space-y-4 relative">
                    ...
                    <motion.div variants={fadeIn} className="group p-10 rounded-[40px] border bg-card hover:border-indigo-500/50 transition-all hover:-translate-y-2 relative overflow-hidden shadow-sm">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:scale-110 transition-transform">
                            <ShieldCheck className="h-24 w-24 text-indigo-500" aria-hidden="true" />
                        </div>
                        <div className="space-y-4 relative">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            ...
                            className="rounded-[40px] border bg-card p-1 relative overflow-hidden group shadow-2xl"
                        >
                ...
                >
                    <motion.div variants={slideIn('left')} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <motion.div whileHover={{ y: -5 }} className="p-6 rounded-3xl bg-card border border-[#FB923C]/20 shadow-xl shadow-[#FB923C]/5 space-y-2">
                    ...
                    <motion.div variants={slideIn('right')} className="relative">
                        <div className="rounded-[40px] border-8 border-[#FB923C]/10 bg-card p-8 shadow-2xl relative">
                            <div className="space-y-6">
                                <div className="flex items-center justify-between pb-6 border-b">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-[#FB923C]/20 flex items-center justify-center">
                                            <Users className="h-5 w-5 text-[#FB923C]" aria-hidden="true" />
                                        </div>
                                        <div>
                                ...
                                <div className="flex items-center justify-between p-3 rounded-2xl bg-muted/30 border border-dashed hover:bg-muted/50 transition-colors">
                                    ...
                                    <Link href="https://www.linkedin.com/in/avesh-pathak/" target="_blank" className="p-1.5 rounded-full bg-[#0077B5]/10 text-[#0077B5]" aria-label="Visit Vikram Singh's LinkedIn profile">
                                        <Linkedin className="h-3 w-3 fill-current" aria-hidden="true" />
                                    </Link>
                                </div>
                                <div className="flex items-center justify-between p-3 rounded-2xl bg-muted/30 border border-dashed hover:bg-muted/50 transition-colors">
                                    <div className="flex items-center gap-3">
                                    ...
                                    <Link href="https://www.linkedin.com/in/avesh-pathak/" target="_blank" className="p-1.5 rounded-full bg-[#0077B5]/10 text-[#0077B5]" aria-label="Visit Sarah Chen's LinkedIn profile">
                                        <Linkedin className="h-3 w-3 fill-current" aria-hidden="true" />
                                    </Link>
                                </div>
                                <Link href="/dashboard/mentorship" className="block">
                                    <Button className="w-full h-14 rounded-2xl bg-[#FB923C] hover:bg-[#FB923C]/90 text-white font-black uppercase tracking-tight shadow-xl shadow-[#FB923C]/20 border-none transition-transform hover:scale-[1.02]">
                                        Find Your Mentor
                                    </Button>
                                </Link>
                            </div>
            ...
            {/* FAQ Section */}
            <section className="py-24 bg-background border-t overflow-hidden">
                <motion.div
                    initial="initial"
                    whileInView="animate"
                    viewport={{ once: true }}
                ...
                >
                    <motion.div variants={fadeIn} className="text-center space-y-4 mb-16">
                        ...
                        <p className="text-muted-foreground font-medium">Everything you need to know about Babua LMS.</p>
                    </motion.div>
                    <div className="space-y-8">
                        {[
                            { q: "What is Babua LMS?", a: "The **Babua LMS** is a curated collection of **30+ high-impact patterns** and 200+ selected problems. It's designed to build intuition for competitive programming and technical interviews." },
                            { q: "How is it different from other sheets?", a: "Unlike traditional sheets that focus on rote memorization, **Babua LMS** focuses on **Mastering Patterns**. Once you understand the underlying pattern (like Two Pointers or Sliding Window), you can solve hundreds of similar problems effortlessly." },
                            { q: "Is Babua LMS free?", a: "Yes, **Babua LMS** and all its learning paths are 100% free. We follow a \"Proof of Work\" model where your progress is your certificate." },
                            { q: "Can I use it for interview preparation?", a: "Absolutely. **Babua LMS** covers patterns frequently asked in top-tier companies like Google, Meta, and Amazon." }
                        ].map((faq, idx) => (
                            <motion.div
                                key={idx}
                                variants={fadeIn}
                                whileHover={{ scale: 1.01 }}
                                className="p-8 rounded-[32px] border bg-card/50"
                            >
                                <h3 className="text-xl font-black uppercase tracking-tight mb-4">{faq.q}</h3>
            ...
            <section className="py-32 bg-[#FB923C] relative overflow-hidden text-white">
                ...
                <motion.div
                    ...
                    className="max-w-7xl mx-auto px-6 text-center space-y-10 relative"
                >
                    ...
                    <div className="flex justify-center">
                        <Link href="/dashboard">
                            <Button size="lg" className="bg-white text-[#FB923C] hover:bg-white/90 h-20 px-16 rounded-full text-2xl font-black uppercase tracking-tight shadow-[0_0_50px_rgba(255,255,255,0.3)] border-none transition-transform hover:scale-110">
                                Launch Hub Now
                            </Button>
                        </Link>
                    </div>
            ...
            <footer className="py-12 border-t">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <p className="text-xs font-medium text-muted-foreground opacity-60">© 2024 Babua LMS. All rights reserved.</p>
                </div>
            </footer>
        </div>
    )
